...
#ifndef MIDWARE2_DYNAMICLIBRARY_H
#define MIDWARE2_DYNAMICLIBRARY_H
...
public:
    ...
    std::string get_last_error_string(void) {
        LPVOID lpMsgBuf;
        ...
        std::string err = (const char *) lpMsgBuf;
        LocalFree(lpMsgBuf);
        return err;
    }
...
#endif //MIDWARE2_DYNAMICLIBRARY_H
